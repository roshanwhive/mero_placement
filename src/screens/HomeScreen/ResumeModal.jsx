...
const ResumeModal = ({ hideModal, slug }) => {
    ...
    const { resume, messageConfirm, isErrorConfirm, isSuccessConfirm, statusCodeConfirm } = useSelector(state => state.jobApply);
                ...
                <View style={styles.container}>
                    <View style={styles.modalContent}>
                        <View style={styles.body}>
                            ...
                            <Text style={styles.subtitle}>Select the most suitable CV for this job!</Text>
                            <View style={{
                                padding: 4, width: '100%', marginBottom: 8,
                            }}>
                                <Dropdown
                                    data={resumeData}
